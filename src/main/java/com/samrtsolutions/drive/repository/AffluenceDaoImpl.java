...
public class AffluenceDaoImpl extends BaseDaoImpl<Affluence> implements AffluenceDao{
    ...
    public String incrementerQteCommande (int codeMag, int codeCreneau, String date){
        ...
        try (Session session  = HibernateUtil.getSessionFactory().getCurrentSession()){
            ...
            if (!exister){
                ...
                addRowCommande (codeMag, codeCreneau, dateKey);
                ...
                List<Affluence> listeAffluQteCom = (List<Affluence>)queryQteCom.list();
                ...
                if (qteCom == 10){ //Un créneau ne peut accueillir que 10 commandes en même temps
                    ...
                    List<Affluence> listeAffluence = (List<Affluence>)addQteCom.list();
                    Affluence objetRecupere = listeAffluence.get(0);
                    objetRecupere.setQteCommande(objetRecupere.getQteCommande()+1);
                  
                    
                    response = "Votre commande a bien été enregistrée !";
                    session.save(objetRecupere);
                    t.commit();
                    return response;
                }
            }
    ...
    public void addRowCommande (int codeMag, int codeCreneau, Date_Affluence dateAffluence){
        Session session  = HibernateUtil.getSessionFactory().openSession();
                ...
                Date_Affluence d = dateAfflu.get(dateAffluence.getCodeDate());
