...
public class TestProductImplement {
    ...
    private static LabelDaoImpl lao = new LabelDaoImpl();
    
    @Test
    @Ignore
    public void testAddProduct(){
        Product p1 = new Product("Pomme",3.00,2,200,"Pomme du sud","Gramme","31AAA","","Maroc","Carrefour","Carrefour","..\\ProductImages\\pomme.jpg","A");
        Product p2 = new Product("Pomme française",3.00,2,200,"Pomme du sud","Gramme","31AAA","","Maroc","Carrefour","Carrefour","..\\ProductImages\\pomme.jpg","B");
        Product p3 = new Product("Pomme espagnole",3.00,2,200,"Pomme du sud","Gramme","31AAA","","Maroc","Carrefour","Carrefour","..\\ProductImages\\pomme.jpg","A");
        pi.edit(p1);
        pi.edit(p2);
        pi.edit(p3);
